...
create TABLE chto_posmotret (id SERIAL PRIMARY KEY, title VARCHAR(200), sub_title VARCHAR(200), address VARCHAR(100), contacts TEXT, image_id SERIAL, category VARCHAR(100), tags VARCHAR(100), template TEXT );